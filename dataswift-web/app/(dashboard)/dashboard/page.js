  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-secondary/40 text-sm mt-1">What would you like to do today?</p>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <Card>
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xl font-extrabold text-secondary">{formatCurrency(user?.walletBalance || 0)}</p>
              <p className="text-xs text-secondary/40">Balance</p>
            </div>
          </div>
        </Card>
        <Card>
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xl font-extrabold text-secondary">0</p>
        ...
        <Card>
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xl font-extrabold text-secondary">0</p>
              <p className="text-xs text-secondary/40">Referrals</p>
            </div>
          </div>
        </Card>
        <Card>
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xl font-extrabold text-secondary">{formatCurrency(0)}</p>
              <p className="text-xs text-secondary/40">This Month</p>
            </div>
          </div>
        </Card>
      </div>
      ...
      <Card className="!p-0 overflow-hidden">
        <div className="p-5 sm:p-6 border-b border-secondary/[0.06]">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="font-bold text-lg text-secondary">Quick Buy</h2>
              <p className="text-xs text-secondary/40 mt-0.5">Choose a network to get started</p>
            </div>
            <Link href="/buy">
          ...
          <div className="grid grid-cols-3 gap-4">
            {[
              ...
              <Link key={net} href={`/buy?network=${net}`}>
                <div className="p-4 rounded-2xl border-2 border-secondary/[0.06] hover:border-primary/30 hover:shadow-md hover:shadow-primary/5 transition-all text-center group cursor-pointer">
                  ...
                  <div className="mt-2 space-y-1">
                    {popular.map((p, i) => (
                      <p key={i} className="text-[11px] text-secondary/40">{p}</p>
                    ))}
                  </div>
