    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
      <div className="bg-white dark:bg-gray-900 rounded-2xl max-w-sm w-full overflow-hidden shadow-2xl animate-[modal-pop_0.2s_ease-out]">
        ...
        <div className="p-6 text-center">
          ...
          <div className="bg-amber-50 dark:bg-amber-900/30 border border-amber-200 dark:border-amber-600/50 rounded-xl p-4 mb-4">
            <div className="flex items-center justify-center gap-2 mb-2">
              <Clock className="w-4 h-4 text-amber-600 dark:text-amber-400" />
              <span className="text-amber-700 dark:text-amber-400 text-sm font-semibold">Delivery Time</span>
            </div>
      ...
      <div className="min-h-[60vh] flex items-center justify-center">
        <div className="text-center max-w-sm">
          ...
          <div className="flex gap-3 justify-center mt-6">
            <Link href="/quick-buy">
              <button className="px-6 py-3 bg-amber-400 text-black font-bold text-sm rounded-xl hover:bg-amber-500 transition-colors">
                Buy more data
              </button>
            </Link>
            <Link href="/sign-up">
  ...
  return (
    <div className="max-w-5xl mx-auto px-2 sm:px-4 py-3 sm:py-6">
                  ...
                  <div className={`col-span-1 sm:col-span-2 lg:col-span-3 xl:col-span-4 bg-white dark:bg-gray-800 rounded-2xl p-3 sm:p-4 shadow-md border ${cardStyle.border}`}>
                    ...
                    <div className="max-w-md mx-auto space-y-2">
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2.5 rounded-xl bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 border border-gray-200 dark:border-gray-600 focus:border-amber-400 focus:ring-1 focus:ring-amber-400 focus:outline-none text-center font-medium text-sm"
                      />
                      {/* Phone + Buy button */}
      ...
      <div className="mt-8 p-6 rounded-2xl text-center bg-white dark:bg-gray-800 shadow-sm">
        <User className="w-10 h-10 mx-auto mb-3 text-amber-500 dark:text-amber-400" />
        ...
        <div className="flex justify-center gap-3">
          ...
          <Link href="/sign-up" className="px-5 py-2 bg-amber-400 hover:bg-amber-500 text-black font-semibold rounded-lg transition-colors">
            Sign Up Free
          </Link>
        </div>
      </div>
