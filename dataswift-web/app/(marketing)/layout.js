...
export default function MarketingLayout({ children }) {
  ...
  return (
    <div className={`min-h-screen ${isDarkMode ? 'dark bg-gray-950' : 'bg-white'}`}>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <button
              ...
              className="md:hidden w-10 h-10 rounded-xl bg-amber-400 text-black flex items-center justify-center hover:bg-amber-500 active:scale-95 transition-all"
            >
      ...
      {/* Footer — DataMart-style multi-column */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div className="lg:col-span-1">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Your trusted source for affordable data bundles in Ghana. Fast, reliable, and secure.
              </p>
            </div>

            {/* Quick Links */}
            <div>
              <h3 className="text-sm font-semibold uppercase tracking-wider mb-4 text-amber-600 dark:text-amber-400">
                Quick Links
              </h3>
              <ul className="space-y-3">
                {[
                  ...
                  <li key={link.name}>
                    ...
                    >
                      <ChevronRight size={14} className="mr-1 opacity-0 -ml-4 group-hover:opacity-100 group-hover:ml-0 transition-all text-amber-600 dark:text-amber-400" />
                      {link.name}
                    </Link>
                  </li>
                ))}
                ...
                {[
                  ...
                  <li key={bundle.name}>
                    ...
                    >
                      ...
                      {bundle.name}
                      {bundle.isNew && (
                        <span className="ml-2 px-1.5 py-0.5 bg-amber-400 text-black text-[10px] font-bold rounded-full">
                          NEW
                        </span>
                      )}
                    </Link>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-700 dark:text-gray-300">support@swiftbundle.com</p>
                  </div>
                </div>
          ...
          <div className="mt-10 pt-6 border-t border-gray-200 dark:border-gray-800">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              <p className="text-sm text-gray-500">
                &copy; {new Date().getFullYear()} SwiftBundle Ghana. All rights reserved.
              </p>
